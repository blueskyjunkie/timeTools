...
class TestTdev (unittest.TestCase):
    ...
    def testSingleProcesTdev1 (self):
        ...
        self.assertTrue(len(directObservationIntervals) == len(fastObservationIntervals), 'TDEV observation interval lengths not equal')
        
        self.assertTrue(numpy.all(directObservationIntervals == fastObservationIntervals), 'TDEV observations intervals not equal')
